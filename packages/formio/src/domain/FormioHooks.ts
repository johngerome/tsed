...
import "resourcejs";
import {RestOptions} from "resourcejs";
...
export interface FormioHooks {
  ...
  alter?: {
     ...
     */
    actionRoutes?: (options: RestOptions) => RestOptions;
    /**
     * Alter roles routes.
     */
    rolesRoutes?: (options: RestOptions) => RestOptions;
    /**
     * Alter forms routes.
     */
    formRoutes?: (options: RestOptions) => RestOptions;
    /**
     * Alter submission routes.
     */
    submissionRoutes?: (options: RestOptions) => RestOptions;
